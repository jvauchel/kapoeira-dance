...
* {burger-quiz-url}/fries-factory/it/features/fries-us2-files-tips.feature[A feature with a tip^]
...
=== User Story n°6 (End To End) image:images/burger-quiz.gif[width=200,float=right]
image::diagrams/burger-quiz.svg[width=800]

=== User Story n°6 (End To End) - Solution
{burger-quiz-url}/end-to-end/it/features/end-to-end-us6.feature[Here^]

=== User Story n°6 (End To End) - Report
TODO
