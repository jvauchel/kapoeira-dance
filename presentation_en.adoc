...
// TODO le tissu https://www.youtube.com/watch?v=4LTBB13ZQX0
// TODO Lectra entreprise à Cestas
...
=== Ready to contribute ? https://github.com/lectra-tech/kapoeira/blob/main/CONTRIBUTING.adoc[Here^] 
...
Feedback
a|image:images/qrcode.png[width=300]
...
a|ifdef::conf-webinar[image:images/WebinarQRCode.png[width=300]]
ifdef::conf-bdxio[image:images/BDXIOQRCode.png[width=300]]
|===
