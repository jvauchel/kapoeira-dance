...
As a cooker, WHEN I send a potato to my robot, THEN I expect to have a set of delicious french fries.
...
As a cooker, WHEN I send potatoes to my robot, THEN I expect to have several sets of delicious french fries.

=== User Story n°3

As a cooker, WHEN I send a potato to my robot, with KETCHUP header request, THEN I expect to have a set of delicious french fries with KETCHUP.
